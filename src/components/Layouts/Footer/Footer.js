...
export const Footer = () => {
  return (
    <footer>
      ...
      <div className="footer-bottom oianjdshihfsf d-flex py-2 justify-content-center align-items-center">
      ...
      <div className="footer-bottom sdcasdsfsdfsdf d-flex justify-content-center align-items-center">
